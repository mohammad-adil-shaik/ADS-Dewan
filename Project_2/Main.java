...
public class Main {
	...
	static String getInputFilePathDijkstra(int inputFile) {
		...
		switch (inputFile) {
		case 1:
			filePath = "D:/Github/ADS/ADS/Project_2/dijkstra_graphs/Undirected_1.txt";
			break;
		case 2:
			filePath = "D:/Github/ADS/ADS/Project_2/dijkstra_graphs/directed_2.txt";
			break;
		case 3:
			filePath = "D:/Github/ADS/ADS/Project_2/dijkstra_graphs/Undirected_3.txt";
			break;
		case 4:
			filePath = "D:/Github/ADS/ADS/Project_2/dijkstra_graphs/Undirected_4.txt";
			break;
		default:
	...
	static String getInputFilePathKruskal(int inputFile) {
		...
		switch (inputFile) {
		case 1:
			filePath = "D:/Github/ADS/ADS/Project_2/kruskal_graphs/Undirected_1.txt";
			break;
		case 2:
			filePath = "D:/Github/ADS/ADS/Project_2/kruskal_graphs/Undirected_2.txt";
			break;
		case 3:
			filePath = "D:/Github/ADS/ADS/Project_2/kruskal_graphs/Undirected_3.txt";
			break;
		case 4:
			filePath = "D:/Github/ADS/ADS/Project_2/kruskal_graphs/Undirected_4.txt";
			break;
		default:
			System.out.println("You selected an invalid option. Default file selected is 1.\n");
    ...
    static String getInputFilePathDFS(int inputFile) {
        ...
        switch (inputFile) {
            case 1:
                filePath = "D:/Github/ADS/ADS/Project_2/dfs_graphs/directed_1_acyclic.txt";
                break;
            case 2:
                filePath = "D:/Github/ADS/ADS/Project_2/dfs_graphs/directed_2_acyclic.txt";
                break;
            case 3:
                filePath = "D:/Github/ADS/ADS/Project_2/dfs_graphs/directed_3_cyclic.txt";
                break;
            case 4:
                filePath = "D:/Github/ADS/ADS/Project_2/dfs_graphs/directed_4_cyclic.txt";
                break;
            default:
                System.out.println("You selected an invalid option. Default file selected is 1.\n");
